package ragdolls.physics.entity;
...
public class RagdollCharacter {
	...
	public RagdollCharacter(DynamicsWorld ownerWorld, Vector3f positionOffset) {
		this(ownerWorld, positionOffset, 1.0f);
	}

	public RagdollCharacter(DynamicsWorld ownerWorld, Vector3f positionOffset, float scale_ragdoll) {
		...
		for (int i = 0; i < BodyPart.BODYPART_COUNT.ordinal(); ++i) {
			...
			//GRAVITY!
			bodies[i].setGravity(new Vector3f(0, -50, 0));
		}
		
		float rangeSpineHead = 0.3f;
