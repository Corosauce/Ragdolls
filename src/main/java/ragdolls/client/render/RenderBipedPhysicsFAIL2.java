...
public class RenderBipedPhysicsFAIL2 extends RenderLiving
{
    public ModelBipedPhysics modelBipedMain;
    ...
    public RenderBipedPhysicsFAIL2(ModelBipedPhysics par1ModelBiped, float par2)
    {
        this(par1ModelBiped, par2, 1.0F);
    }

    public RenderBipedPhysicsFAIL2(ModelBipedPhysics par1ModelBiped, float par2, float par3)
    {
