...
import ragdolls.client.render.model.ModelBipedPhysics;
import ragdolls.client.render.model.ModelZombiePhysics;
...
public class RenderZombiePhysics extends RenderBipedPhysics
{
    ...
    public RenderZombiePhysics()
    {
        super(new ModelZombiePhysics(), 0.5F);
    ...
    {
        this.field_82423_g = new ModelZombiePhysics(1.0F, true);
        this.field_82425_h = new ModelZombiePhysics(0.5F, true);
